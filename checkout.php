            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="index.php"> <img src="img/Logo Q Store.png" width="110px" alt="logo"> </a>
          ...
          <div class="col-lg-8">
            ...
            <form class="row contact_form" action="#" method="post" novalidate="novalidate">
              ...
              <div class="col-md-12 form-group p_star">
                ...
                <span class="placeholder" data-placeholder="No. Telp"></span>
              </div>
              <div class="col-md-12 form-group p_star">
            ...
            <div class="order_box">
              ...
              <ul class="list">
                ...
                <li>
                  <a href="#">Busi
                    ...
                    <span class="last">Rp 35.000</span>
                  </a>
                </li>
                <li>
                  <a href="#">Packing Head
                    <span class="middle">x 1</span>
                    <span class="last">Rp 150.000</span>
                  </a>
                </li>
                <li>
                  <a href="#">Kampas rem belakang
                    <span class="middle">x 1</span>
                    <span class="last">Rp 245.000</span>
                  </a>
                </li>
              </ul>
              ...
              <div class="payment_item active">
                <div class="radion_btn">
                  ...
                  <label for="f-option6">GoPay </label>
                  <div class="check"></div>
                </div>
              </div>
              <a class="btn_3" href="#">Bayar</a>
            </div>
          </div>
        </div>
      </div>
